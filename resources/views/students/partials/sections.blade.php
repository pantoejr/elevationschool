<div class="grid grid-cols-1">
    <div class="overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-800">Student Sections</h2>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    @foreach ($model->studentSections as $studentSection)
                        <tr class="hover:bg-gray-50 transition duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-md font-medium">
                                @can('edit-installment')
                                    <button type="button"
                                        data-modal-target="edit-student-section-modal-{{ $studentSection->id }}"
                                        data-modal-toggle="edit-student-section-modal-{{ $studentSection->id }}"
                                ...
                                @can('delete-installment')
                                    <form
                                        action="{{ route('studentSections.destroy', ['student' => $model, 'section' => $studentSection]) }}"
                        ...
                        {{-- Edit StudentSection Modal --}}
                        <div id="edit-student-section-modal-{{ $studentSection->id }}" tabindex="-1" aria-hidden="true"
                            class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                            <div class="relative p-4 w-full max-w-2xl max-h-full">
                                <!-- Modal content -->
                                <div class="relative bg-white rounded-lg shadow-sm">
                                    <form
                                        action="{{ route('studentSections.update', ['student' => $model, 'section' => $studentSection]) }}"
                                        method="POST">
                                        @method('PUT')
                                        @csrf
                                        <div
                                            ...
                                            <button type="button"
                                                ...
                                                data-modal-hide="edit-student-section-modal-{{ $studentSection->id }}">
