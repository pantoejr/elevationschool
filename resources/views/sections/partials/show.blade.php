            ...
            <form>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-4">
                    <div class="mb-4">
                        ...
                        <input type="number" name="course_cost" disabled value="{{ $model->course_cost }}" class="mt-1 block w-full p-4  rounded-md bg-gray-100 focus:outline-none">
                    </div>
                    <div class="mb-4">
                        <label for="currency" class="block text-sm font-medium text-gray-700">Currency</label>
                        <select  name="currency" disabled class="mt-1 block w-full p-4  rounded-md bg-gray-100 focus:outline-none">
                            <option value="USD" {{ old('currency', $model->currency) == 'USD' ? 'selected' : '' }}>USD</option>
                            <option value="LRD" {{ old('currency', $model->currency) == 'LRD' ? 'selected' : '' }}>LRD</option>
                        </select>
                    </div>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-4">
                    <div class="mb-4">
                        ...
                        <input type="date" name="start_date" id="start_date" value="{{ $model->start_date }}" disabled
                            class="mt-1 block w-full p-4  rounded-md bg-gray-100 focus:outline-none">
                    </div>
                    <div class="mb-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-4">
                    <div class="mb-4">
                        ...
                        <input type="number" name="max_students" id="max_students" value="{{ $model->max_students }}" disabled
                            class="mt-1 block w-full p-4  rounded-md bg-gray-100 focus:outline-none">
                    </div>
                    <div class="mb-4">
