...
Route::prefix('sections/{section}')->group(function () {
    Route::controller(SectionInstallmentController::class)->group(function () {
        Route::post('installments/create', 'store')->name('sectioninstallments.create')->can('add-installment');
        Route::get('installments/{installment}/edit', 'edit')->name('sectioninstallments.edit')->can('edit-installment');
        Route::put('installments/{installment}', 'update')->name('sectioninstallments.update')->can('update-installment');
        Route::delete('installment/{installment}', 'destroy')->name('sectioninstallments.destroy')->can('delete-installment');
    });
});
