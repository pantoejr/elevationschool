...
class PaymentController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            $paymentHelper->makePayment($request->student_id, $request->section_id, 
            $request->amount, $request->payment_method, Auth::user()->name, $request->currency);
            ...
            return redirect()->route('payments.index')
            ->with('success','Payment inserted failed')
            ->with('flag', 'error');
        }
    }
}
